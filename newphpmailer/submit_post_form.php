...
if(!empty($submit))
{
	...
	$message .= '<table cellspacing="0" cellpadding="0" border="0" align="center" width="100%">
              <tr>
                ...
                <td class="contact-form">Number:<font color="red" size="3"></font></td>
                <td class="contact-form">:</td>
                <td width="70%" class="contact-text-form">'.$_REQUEST['number'].'</td>
              </tr>
              <tr>
                <td class="contact-form">Email Id:<font color="red" size="3"></font></td>
                <td class="contact-form">:</td>
                <td width="70%" class="contact-text-form">'.$_REQUEST['email'].'</td>
              </tr>
               <tr>
                <td class="contact-form">Message:<font color="red" size="3"></font></td>
                <td class="contact-form">:</td>
                <td width="70%" class="contact-text-form">'.$_REQUEST['message'].'</td>
              </tr>
			</table>';
	$message .= '</body></html>';
	//End Html Page Here
	...
	$mail->Host = 'www.alibaugproperty.com';	// Specify main and backup SMTP servers
	$mail->SMTPAuth = true;	// Enable SMTP authentication
	$mail->Username = 'alibaugtoggle';	// SMTP username
	$mail->Password = 'Alibaug@123';	// SMTP password
	...
	$mail->addAddress('info@alibaugproperty.com');	// Add a recipient
...
//	$mail->addCC('gaurav@togglehead.in');
	...
	$mail->Subject = 'Email From Alibaug Website';
	$mail->Body = $message;
